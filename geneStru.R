...
geneStru <- function(chr="chr9", start=59001, end=68031){ 
  ...
  start.c <- as.numeric(paste0(sprintf("%02d", as.numeric(substr(chr, 4, 4))), sprintf("%09d", start)))
  end.c <- as.numeric(paste0(sprintf("%02d", as.numeric(substr(chr, 4, 4))), sprintf("%09d", end)))
